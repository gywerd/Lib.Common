...
namespace Lib.Common
{
	...
	/// <Summary>Common Exception</Summary>
	public class ArgumentNullOrEmptyException : ExpressionException
	{
		#region Constructors
		/// <remarks />
		...
		/// <remarks />
		public ArgumentNullOrEmptyException(string? paramName, object? actualValue, string? message) : base(paramName, actualValue, message) { }
		...
		public override string ToErrorString()
		{
			...
			if (this.ExpressionName!=null&&this.ActualValue!=null) return Environment.NewLine+"- An ArgumentNullOrEmptyException occurred ("+this.ExpressionName+": "+this.ActualValue.ToString()+"):"+Environment.NewLine+this+Environment.NewLine;
			else if (this.ExpressionName!=null&&this.ActualValue==null) return Environment.NewLine+"- An ArgumentNullOrEmptyException occurred ("+this.ExpressionName+"):"+Environment.NewLine+this+Environment.NewLine;
			else return Environment.NewLine+"- An ArgumentNullOrEmptyException error occurred:"+Environment.NewLine+this+Environment.NewLine;
	...
	/// <Summary>Common Exception</Summary>
	public class EmptyRefException : ExpressionException
	{
		#region Constructors
		/// <remarks />
		public EmptyRefException() { }

		/// <remarks />
		public EmptyRefException(string? message) : base(message) { }

		/// <remarks />
		public EmptyRefException(string? message, Exception? innerException) : base(message, innerException) { }

		/// <remarks />
		public EmptyRefException(string? refName, object? actualValue, string? message) : base(refName, actualValue, message) { }

		/// <remarks />
		public EmptyRefException(string? refName, string? message) : base(refName, message) { }
		...
		public override string ToErrorString()
		{
			...
			if (this.ExpressionName!=null&&this.ActualValue!=null) return Environment.NewLine+"- A EmptyRefException occurred ("+this.ExpressionName+": "+this.ActualValue.ToString()+"):"+Environment.NewLine+this+Environment.NewLine;
			else if (this.ExpressionName!=null&&this.ActualValue==null) return Environment.NewLine+"- A EmptyRefException occurred ("+this.ExpressionName+"):"+Environment.NewLine+this+Environment.NewLine;
			else return Environment.NewLine+"- A EmptyRefException error occurred:"+Environment.NewLine+this+Environment.NewLine;
	...
	public class ExpressionException : Exception
	{
		...
		/// <remarks />
		public static string ToErrorString(Exception ex) => Environment.NewLine+"- An "+ex.GetType().ToString()+" error occurred:"+Environment.NewLine+ex+Environment.NewLine;

		/// <remarks />
		public static string ToErrorString(ExpressionException ex)
		{
			if (ex.ExpressionName!=null&&ex.ActualValue!=null) return Environment.NewLine+"- An ExpressionException occurred ("+ex.ExpressionName+": "+ex.ActualValue.ToString()+"):"+Environment.NewLine+ex+Environment.NewLine;
			else if (ex.ExpressionName!=null&&ex.ActualValue==null) return Environment.NewLine+"- An ExpressionException occurred ("+ex.ExpressionName+"):"+Environment.NewLine+ex+Environment.NewLine;
			else return Environment.NewLine+"- An ExpressionException error occurred:"+Environment.NewLine+ex+Environment.NewLine;
		}
	...
	public class NullRefException : ExpressionException
	{
		...
		public override string ToErrorString()
		{
			...
			if(this.ExpressionName!=null) return Environment.NewLine+"- A NullRefException occurred ("+this.ExpressionName+"):"+Environment.NewLine+this+Environment.NewLine;
			else return Environment.NewLine+"- A NullRefException error occurred:"+Environment.NewLine+this+Environment.NewLine;
	...
	/// <Summary>Common Exception</Summary>
	public class NullOrEmptyRefException : ExpressionException
	{
		#region Constructors
		/// <remarks />
		public NullOrEmptyRefException() { }

		/// <remarks />
		public NullOrEmptyRefException(string? message) : base(message) { }

		/// <remarks />
		public NullOrEmptyRefException(string? message, Exception? innerException) : base(message, innerException) { }

		/// <remarks />
		public NullOrEmptyRefException(string? refName, string? message) : base(refName, message) { }
		...
		public override string ToErrorString()
		{
			...
			if(this.ExpressionName!=null) return Environment.NewLine+"- A NullOrEmptyRefException occurred ("+this.ExpressionName+"):"+Environment.NewLine+this+Environment.NewLine;
			else return Environment.NewLine+"- A NullOrEmptyRefException error occurred:"+Environment.NewLine+this+Environment.NewLine;
