...
namespace Lib.Common.DataTypes
{
	...
	public class Time : IFormattable
	{
		...
		{
			if (hour<0||hour>23) throw new ArgumentOutOfRangeException(nameof(hour), Error.InvHourInt);
			if (minute<0||minute>59) throw new ArgumentOutOfRangeException(nameof(minute), Error.InvMinInt);
			if (second<0||second>59) throw new ArgumentOutOfRangeException(nameof(second), Error.InvSecInt);
		...
		public Time(string hour, string minute, string second)
		{
			...
			if (Convert.ToInt32(hour)<0||Convert.ToInt32(hour)>23) throw new ArgumentOutOfRangeException(nameof(hour), hour, Error.InvHourStr);
			if (Convert.ToInt32(minute)<0||Convert.ToInt32(minute)>59) throw new ArgumentOutOfRangeException(nameof(minute), minute, Error.InvMinStr);
			if (Convert.ToInt32(second)<0||Convert.ToInt32(second)>59) throw new ArgumentOutOfRangeException(nameof(second), second, Error.InvSecStr);
	...
	public class Minute : IFormattable
	{
		...
		{
			if (minute<0||minute>59) throw new ArgumentInvalidException(nameof(minute), minute, Error.InvMinInt);
		...
		{
			if (!string.IsNullOrWhiteSpace(minute)) throw new ArgumentNullOrWhiteSpaceException(nameof(minute), minute, nameof(minute)+Error.CantBeNullWhSp);
			if (Convert.ToInt32(minute)<0||Convert.ToInt32(minute)>59) throw new ArgumentInvalidException(nameof(minute), minute, Error.InvMinStr);
	...
	public class Hour : IFormattable
	{
		...
		{
			if (hour<0||hour>23) throw new ArgumentInvalidException(nameof(hour), hour, Error.InvHourInt);
		...
		{
			if (!string.IsNullOrWhiteSpace(hour)) throw new ArgumentNullOrWhiteSpaceException(nameof(hour), hour, nameof(hour)+Error.CantBeNullWhSp);
			if (Convert.ToInt32(hour)<0||Convert.ToInt32(hour)>59) throw new ArgumentInvalidException(nameof(hour), hour, Error.InvMinStr);
		...
		{
			if (hour<0) throw new ArgumentInvalidException(nameof(hour), hour, Error.InvHourInt);
	...
	public class Second : IFormattable
	{
		...
		{
			if (second<0||second>59) throw new ArgumentInvalidException(nameof(second), second, Error.InvSecInt);
		...
		{
			if (!string.IsNullOrWhiteSpace(second)) throw new ArgumentNullOrWhiteSpaceException(nameof(second), second, nameof(second)+Error.CantBeNullWhSp);
			if (Convert.ToInt32(second)<0||Convert.ToInt32(second)>59) throw new ArgumentInvalidException(nameof(second), second, Error.InvMinStr);
