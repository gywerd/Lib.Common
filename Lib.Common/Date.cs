...
namespace Lib.Common.DataTypes
{
	...
	public class Date : IFormattable
	{
		...
		{
			if (year<1900||year>9999) throw new ArgumentOutOfRangeException(nameof(year), Error.InvYearInt);
			if (month<1||month>9999) throw new ArgumentOutOfRangeException(nameof(month), Error.InvMonInt);
			if (day<1||year>9999) throw new ArgumentOutOfRangeException(nameof(day), Error.InvDayInt);
		...
		public Date(string year, string month, string day)
		{
			...
			if (Convert.ToInt32(year)<1900||Convert.ToInt32(year)>9999) throw new ArgumentOutOfRangeException(nameof(year), year, Error.InvYearInt);
			if (Convert.ToInt32(month)<1||Convert.ToInt32(month)>9999) throw new ArgumentOutOfRangeException(nameof(month), month, Error.InvMonInt);
			if (Convert.ToInt32(day)<1||Convert.ToInt32(day)>9999) throw new ArgumentOutOfRangeException(nameof(day), day, Error.InvDayInt);
		...
		public static implicit operator Date(string date)
		{
			...
			if (!IsValid(date)) throw new ArgumentInvalidException(nameof(date),date,nameof(date)+Error.InvDateStr);
		...
		{
			if (this==null) throw new NullReferenceException(); // This is necessary to safe guard the class
			if (!IsValid(date)) throw new ArgumentInvalidException(nameof(date), date, date+Error.InvDateStr);
	...
	public class Day : IFormattable
	{
		...
		private Day(int day)
		{
			if (day<1||day>31) throw new ArgumentInvalidException(nameof(day), day, Error.InvDayInt);
		...
		{
			if (!string.IsNullOrWhiteSpace(day)) throw new ArgumentNullOrWhiteSpaceException(nameof(day), day, nameof(day)+Error.CantBeNullWhSp);
			if (Convert.ToInt32(day)<1||Convert.ToInt32(day)>31) throw new ArgumentInvalidException(nameof(day), day, Error.InvDayStr);
	...
	public class Month : IFormattable
	{
		...
		{
			if (month<1||month>12) throw new ArgumentInvalidException(nameof(month), month, Error.InvMonInt);
		...
		{
			if (!string.IsNullOrWhiteSpace(month)) throw new ArgumentNullOrWhiteSpaceException(nameof(month), month, nameof(month)+Error.CantBeNullWhSp);
			if (Convert.ToInt32(month)<1||Convert.ToInt32(month)>12) throw new ArgumentInvalidException(nameof(month), month, Error.InvMonStr);
		...
		{
			if (month<1||month>12) throw new ArgumentInvalidException(nameof(month),month,nameof(month)+Error.InvMonInt);
	...
	public class Year : IFormattable
	{
		...
		{
			if (year<1||year>12) throw new ArgumentInvalidException(nameof(year), year, Error.InvMonInt);
		...
		{
			if (!string.IsNullOrWhiteSpace(year)) throw new ArgumentNullOrWhiteSpaceException(nameof(year), year, nameof(year)+Error.CantBeNullWhSp);
			if (Convert.ToInt32(year)<1||Convert.ToInt32(year)>12) throw new ArgumentInvalidException(nameof(year), year, Error.InvMonStr);
		...
		{
			if (!year.ToString().Length.Equals(4)||Convert.ToInt32(year)<1900||Convert.ToInt32(year)<9999) throw new ArgumentOutOfRangeException(nameof(year), year, Error.InvYearInt);
		...
		public static bool IsLeapYear(string year)
		{
			...
			if (string.IsNullOrWhiteSpace(year)) throw new ArgumentNullOrWhiteSpaceException(nameof(year), year, nameof(year)+Error.CantBeNullWhSp);
			if (!year.Length.Equals(4)||Convert.ToInt32(year)<1900||Convert.ToInt32(year)<9999) throw new ArgumentOutOfRangeException(nameof(year), year, Error.InvYearStr);
		...
		{
			if (year<0) throw new ArgumentInvalidException(nameof(year), year, nameof(year)+Error.InvYearInt);
